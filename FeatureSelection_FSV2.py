...
def featureSelection_v2(features_df = None):
    ...
    feature_ranking_correlation['Correlation_Stand'] = list((feature_ranking_correlation['Correlation_Sum'] - np.min(feature_ranking_correlation['Correlation_Sum'])) / (np.max(feature_ranking_correlation['Correlation_Sum']) - np.min(feature_ranking_correlation['Correlation_Sum'])))
    feature_ranking_correlation['Correlation_Flipped'] = 1 - feature_ranking_correlation['Correlation_Stand'] 
    feature_ranking_correlation.sort_values(by = ['Correlation_Flipped'], ascending = False, inplace = True)
    feature_ranking_correlation.reset_index(drop = True, inplace = True)
    feature_ranking_correlation['Feature_ranking_CR'] = 1
    feature_ranking_correlation['Feature_ranking_CR'] = feature_ranking_correlation['Feature_ranking_CR'].cumsum()
    print(feature_ranking_lap_score)
    ...
    feature_ranking['1st_ranking_count'] = np.where(feature_ranking['Feature_ranking_CR'] == 1, feature_ranking['1st_ranking_count'] + 1, feature_ranking['1st_ranking_count'])
    ...
    feature_ranking['2nd_ranking_count'] = np.where(feature_ranking['Feature_ranking_CR'] == 2, feature_ranking['2nd_ranking_count'] + 1, feature_ranking['2nd_ranking_count'])
    ...
    feature_ranking['3rd_ranking_count'] = np.where(feature_ranking['Feature_ranking_CR'] == 3, feature_ranking['3rd_ranking_count'] + 1, feature_ranking['3rd_ranking_count'])
